...
class VcJwtParserTest {

    private VcJwtParser sut = new VcJwtParser();


    @SneakyThrows
    @Test
    void givenValidSdJwt_whenCanParse_thenExpectFalse() {
        // Arrange
    ...
    @SneakyThrows
    @Test
    void givenValidVcJwt_whenCanParse_thenExpectTrue() {
        // Arrange
    ...
    @SneakyThrows
    @Test
    void givenValidVcJwt_whenParse_thenExpectCorrectDto() {
        // Arrange
        final JsonNode jsonNode = new ObjectMapper().readTree(vcJwtJson);
        ...
        assertThat(credentialMetaDataDto.get().getType()).isEqualTo("KVKRegistration");
        assertThat(credentialMetaDataDto.get().issuerDid).isEqualTo("did:web:mijnkvk.acc.credenco.com:did:df63abc0-2cc9-49e5-b3f8-42a824ceb9a7-iss");
        assertThat(credentialMetaDataDto.get().subjectDid).isEqualTo("did:web:wallet.fat1.credenco.com:did:8c12e948-f9b4-4788-b606-2585cc279e89-sub");
    ...
    String vcJwtJson = """
            {
                "iss": "did:web:mijnkvk.acc.credenco.com:did:df63abc0-2cc9-49e5-b3f8-42a824ceb9a7-iss",
                "sub": "did:web:wallet.fat1.credenco.com:did:8c12e948-f9b4-4788-b606-2585cc279e89-sub",
                "vc": {
                  "@context": [
